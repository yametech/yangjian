 ...
 * 
 * @author liuzhao
 * @date 2020年4月26日 下午1:50:46
 */
public class CustomMatcher implements InterceptorMatcher {
	...
	public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
		return new LoadClassKey("com.yametech.yangjian.agent.core.runstatus.custom.CollectInstanceInterceptor");
	}

 ...
 */
public class StatisticMethodMatcher implements IMetricMatcher, IConfigReader {
...
//    }
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
    	return new LoadClassKey("com.yametech.yangjian.agent.plugin.method.StatisticMethodConvert");
    }
}

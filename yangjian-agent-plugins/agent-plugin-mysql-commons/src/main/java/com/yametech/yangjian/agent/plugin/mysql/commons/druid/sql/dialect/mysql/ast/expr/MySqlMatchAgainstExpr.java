 ...
 */
package com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.dialect.mysql.ast.expr;
...
public class MySqlMatchAgainstExpr extends SQLExprImpl implements MySqlExpr {
    ...
    public enum SearchModifier {
        ...
        SearchModifier(String name){
            this.name = name;
            this.name_lcase = name == null ? null : name.toLowerCase();
        }
    }
    ...
    public boolean equals(Object obj) {
        ...
        return searchModifier == other.searchModifier;
    }

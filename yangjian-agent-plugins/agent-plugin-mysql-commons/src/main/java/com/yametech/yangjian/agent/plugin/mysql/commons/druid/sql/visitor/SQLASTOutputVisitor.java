...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.*;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.*;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.statement.*;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.statement.SQLCreateTriggerStatement.TriggerType;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.statement.SQLInsertStatement.ValuesClause;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.statement.SQLJoinTableSource.JoinType;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.dialect.oracle.ast.OracleSegmentAttributes;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.util.Utils;
...
public class SQLASTOutputVisitor extends SQLASTVisitorAdapter implements ParameterizedVisitor, PrintableVisitor {
    ...
    static {
        try {
            defaultPrintStatementAfterSemi = Utils.getBoolean(System.getProperties(), "druid.sql.output.printStatementAfterSemi"); // compatible for early versions
        } catch (Throwable ex) {
            // skip
        }
    }

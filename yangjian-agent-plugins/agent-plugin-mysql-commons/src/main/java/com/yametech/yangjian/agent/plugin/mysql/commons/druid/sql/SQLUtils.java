 ...
 */
package com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.dialect.mysql.visitor.MySqlSchemaStatVisitor;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.parser.*;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.util.*;
...
public class SQLUtils {
    ...
    private final static ILogger LOG = LoggerFactory.getLogger(SQLUtils.class);
    ...
    public static String format(String sql, String dbType, List<Object> parameters, FormatOption option) {
        try {
            ...
            LOG.warn(ex, "format error, dbType : " + dbType);
            return sql;
        } catch (ParserException ex) {
            LOG.warn(ex, "format error");
            return sql;
        }
    }

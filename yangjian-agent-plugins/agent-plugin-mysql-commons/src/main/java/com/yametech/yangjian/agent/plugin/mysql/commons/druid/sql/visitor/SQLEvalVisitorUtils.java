...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.DruidRuntimeException;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.dialect.mysql.visitor.MySqlEvalVisitorImpl;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.util.HexBin;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.visitor.functions.*;
...
public class SQLEvalVisitorUtils {
    ...
    public static boolean visit(SQLEvalVisitor visitor, SQLBetweenExpr x) {
        ...
        if (lt(value, begin)) {
            x.getAttributes().put(SQLEvalVisitor.EVAL_VALUE, x.isNot());
            return false;
        }
    ...
    public static boolean visit(SQLEvalVisitor visitor, SQLInListExpr x) {
        ...
        if (!valueExpr.containsAttribute(SQLEvalVisitor.EVAL_VALUE)) {
            return false;
        }

 ...
 */
package com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.visitor;

import java.util.ArrayList;
import java.util.List;

import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLAdhocTableSource;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLArgument;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLArrayDataType;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLCommentHint;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLCurrentTimeExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLCurrentUserExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLDataType;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLDataTypeRefExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLDeclareItem;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLKeep;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLLimit;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLMapDataType;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLOver;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLPartitionByHash;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLPartitionByList;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLPartitionByRange;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLPartitionValue;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLRecordDataType;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLStructDataType;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLSubPartition;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLSubPartitionByHash;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLSubPartitionByList;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.SQLWindow;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLAggregateExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLAllColumnExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLAllExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLAnyExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLArrayExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLBetweenExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLBinaryExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLBinaryOpExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLBinaryOpExprGroup;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLBooleanExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLCaseExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLCaseStatement;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLCastExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLCharExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLContainsExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLCurrentOfCursorExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLDateExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLDecimalExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLDefaultExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLExistsExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLFlashbackExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLGroupingSetExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLHexExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLIdentifierExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLInListExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLInSubQueryExpr;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLListExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLMethodInvokeExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLNCharExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLNotExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLNullExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLNumberExpr;
...
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLRealExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLSequenceExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLSizeExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLSomeExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLTimestampExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLUnaryExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLValuesExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.expr.SQLVariantRefExpr;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.statement.*;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.statement.SQLInsertStatement.ValuesClause;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.statement.SQLMergeStatement.MergeInsertClause;
import com.yametech.yangjian.agent.plugin.mysql.commons.druid.sql.ast.statement.SQLMergeStatement.MergeUpdateClause;

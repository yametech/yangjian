 ...
 * @date 2020/8/17
 */
public class RunStatusReporter implements IReport, IConfigReader {

    private static final String URL_CONFIG_KEY = "report.http-status.url";

    private static final String REPORT_TYPE = "http-status";
    /**
     * 上报的URL
     */
    private String url;

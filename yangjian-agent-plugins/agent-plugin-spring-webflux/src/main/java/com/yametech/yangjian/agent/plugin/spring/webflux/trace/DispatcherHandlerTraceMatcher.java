 ...
 * @date 2020/4/26
 */
public class DispatcherHandlerTraceMatcher implements ITraceMatcher {
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.spring.webflux.trace.DispatcherHandlerSpanCreater");
    }
}
 ...
 * @date 2020/6/3
 */
public class MethodHandlerAdapterMatcher implements IMetricMatcher {
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.spring.MethodHandlerAdapterConvert");
    }
}

 ...
 * @date 2020/6/14
 */
public class RedisClientMatcher implements IEnhanceClassMatch, InterceptorMatcher {

    @Override
    public IConfigMatch classMatch() {
        return new ClassMatch("io.lettuce.core.RedisClient");
    }
    ...
    public IConfigMatch match() {
        return new CombineAndMatch(Arrays.asList(
                ...
                new MethodArgumentIndexMatch(1, "io.lettuce.core.RedisURI")
        ));
    }

    @Override
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.lettuce.context.RedisClientInterceptor");
    }
}

 ...
 * @date 2020/6/14
 */
public class RedisClusterClientMatcher implements IEnhanceClassMatch, InterceptorMatcher {

    @Override
    public IConfigMatch classMatch() {
        return new ClassMatch("io.lettuce.core.cluster.RedisClusterClient");
    }
    ...
    public IConfigMatch match() {
        return new CombineAndMatch(Arrays.asList(
                ...
                new MethodArgumentIndexMatch(1, "java.lang.Iterable")
        ));
    }

    @Override
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.lettuce.context.RedisClusterClientInterceptor");
    }
}

 ...
 * @date 2020/5/2
 */
public class StatementImplTraceMatcher implements ITraceMatcher {
    @Override
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.mysql.trace.StatementImplSpanCreater");
    }

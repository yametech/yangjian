 ...
 */
package com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser;

import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.CharTypes.isFirstIdentifierChar;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.CharTypes.isIdentifierChar;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.CharTypes.isWhitespace;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.LayoutCharacters.EOI;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.SQLParserFeature.KeepComments;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.SQLParserFeature.OptimizedForParameterized;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.SQLParserFeature.SkipComments;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.COLONCOLON;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.COLONEQ;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.COMMA;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.DOT;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.EOF;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.EQ;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.ERROR;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.LBRACE;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.LBRACKET;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.LITERAL_ALIAS;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.LITERAL_CHARS;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.LPAREN;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.RBRACE;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.RBRACKET;
import static com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token.RPAREN;
...
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.dialect.mysql.parser.MySqlLexer;
...
import com.yametech.yangjian.agent.plugin.mysql.druid.util.StringUtils;
...
public class Lexer {
    ...
    protected boolean isSafeComment(String comment) {
        ...
        //
        return comment.indexOf("select") == -1 //

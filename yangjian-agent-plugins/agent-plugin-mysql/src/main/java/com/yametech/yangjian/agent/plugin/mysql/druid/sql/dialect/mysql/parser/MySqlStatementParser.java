 ...
 */
package com.yametech.yangjian.agent.plugin.mysql.druid.sql.dialect.mysql.parser;

import java.util.ArrayList;
import java.util.List;

import com.yametech.yangjian.agent.plugin.mysql.druid.sql.SQLUtils;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.SQLCommentHint;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.SQLDataType;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.SQLDataTypeImpl;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.SQLDeclareItem;
...
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.SQLOrderBy;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.SQLParameter;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.SQLPartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.SQLStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.SQLParameter.ParameterType;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLBinaryOpExpr;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLBinaryOperator;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLCharExpr;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLIdentifierExpr;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLIntegerExpr;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLIntervalExpr;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLIntervalUnit;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLLiteralExpr;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLPropertyExpr;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLQueryExpr;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.expr.SQLVariantRefExpr;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterCharacter;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterDatabaseStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterFunctionStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterProcedureStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableAddColumn;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableAddConstraint;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableAddIndex;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableAddPartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableAnalyzePartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableCheckPartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableCoalescePartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableConvertCharSet;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDisableConstraint;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDisableKeys;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDiscardPartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDropColumnItem;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDropConstraint;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDropForeignKey;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDropIndex;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDropKey;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDropPartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableDropPrimaryKey;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableEnableConstraint;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableEnableKeys;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableExchangePartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableImportPartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableOptimizePartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableReOrganizePartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableRebuildPartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableRename;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableRenameIndex;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableRepairPartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterTableTruncatePartition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLAlterViewStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLBlockStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLColumnDefinition;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLCommitStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLCreateDatabaseStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLCreateFunctionStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLCreateIndexStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLCreateProcedureStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLCreateTableStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLExprStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLExprTableSource;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLFetchStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLIfStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLInsertStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLLoopStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLPrimaryKey;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLReplaceStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLRollbackStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLSelect;
...
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLSetStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLShowTablesStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLStartTransactionStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLTableConstraint;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLTableSource;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLUnique;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLUpdateSetItem;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLUpdateStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.ast.statement.SQLWhileStatement;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.dialect.mysql.ast.MysqlForeignKey;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.dialect.mysql.ast.clause.ConditionValue;
...
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.dialect.mysql.ast.clause.MySqlHandlerType;
...
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.dialect.mysql.ast.clause.ConditionValue.ConditionType;
...
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.dialect.mysql.ast.statement.MySqlLockTableStatement.LockType;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.EOFParserException;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.InsertColumnsCache;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Lexer;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.ParserException;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.SQLParserFeature;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.SQLSelectParser;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.SQLStatementParser;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.parser.Token;
import com.yametech.yangjian.agent.plugin.mysql.druid.sql.visitor.SQLASTOutputVisitor;

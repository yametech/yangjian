 ...
 * @date 2020/5/2
 */
public class PreparedStatementTraceMatcher implements ITraceMatcher {

    @Override
    public TraceType type() {
        return TraceType.MYSQL;
    }
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.mysql.trace.PreparedStatementSpanCreater");
    }
}

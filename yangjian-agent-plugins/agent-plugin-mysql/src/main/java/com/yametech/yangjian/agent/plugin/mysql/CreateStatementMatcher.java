 ...
 * @date 2020/5/4
 */
public class CreateStatementMatcher implements InterceptorMatcher {
    ...
    public IConfigMatch match() {
        return new CombineOrMatch(Arrays.asList(
                ...
                new CombineAndMatch(Arrays.asList(
                        ...
                        new MethodNameMatch("createStatement"),
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.mysql.CreateStatementInterceptor");
    }
}

 ...
 * @date 2020/6/23
 */
public class MongoClientMatcher implements IEnhanceClassMatch, InterceptorMatcher {
    @Override
    public IConfigMatch classMatch() {
        return new ClassMatch("com.mongodb.MongoClient");
    }
    ...
    public IConfigMatch match() {
        return new CombineAndMatch(Arrays.asList(
                ...
                new MethodNameMatch("getDatabase")
        ));
    }

    @Override
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.mongo.context.MongoClientInterceptor");
    }
}

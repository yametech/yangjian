...
import static com.yametech.yangjian.agent.api.trace.TraceType.HTTP_CLIENT;

/**
 * @author dengliming
 * @date 2020/6/26
 */
public class RestTemplateMatcher implements ITraceMatcher {
    @Override
    public IConfigMatch match() {
        return new CombineAndMatch(Arrays.asList(
                new ClassMatch("org.springframework.web.client.RestTemplate"),
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.resttemplate.trace.RestTemplateSpanCreater");
    }
}

...
public class MethodEventHandler6 implements EventHandler<MethodEvent>, WorkHandler<MethodEvent> {
	private static final Logger log = LoggerFactory.getLogger(MethodEventHandler6.class);

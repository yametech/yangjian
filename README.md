...
方法每秒调用量（QPS），已支持spring-controller、dubbo-client、dubbo-server、httpclient、okhttp、kafka、rabbitmq、mongo集合、mysql表及sql自动统计，jedis、redisson、方法配置化统计；

方法每秒平均耗时（RT），已支持spring-controller、dubbo-client、dubbo-server、httpclient、okhttp、kafka、rabbitmq、mongo集合、mysql表及sql自动统计，jedis、redisson、方法配置化统计；
...
![overview](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/overview.png)

### QPS/RT

![convert](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/convert.png)
...
### WEB场景压测
[测试用例](http://git.ym/g-infrast/tool-ecpark-agent/src/branch/master/ecpark-agent-plugins/agent-plugin-spring/src/test/java/cn/ecpark/tool/agent/plugin/spring/Application.java )  |  [压测脚本](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/jmeter.jmx )  
...
#### CPU and Memory
* Baseline
![CPU and Memory](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/base-perfmon.png )
* With Agent
![CPU and Memory](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/agent-perfmon.png )

#### QPS
* Baseline
![TPS](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/base-tps.png )
* With Agent
![TPS](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/agent-tps.png )

#### ResponseTime
* Baseline
![ResponseTime](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/base-response-time.png )
* With Agent
![ResponseTime](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/agent-response-time.png )
...
####Mysql & Redis 模拟客户端拦截 |  [测试用例](http://git.ym/g-infrast/tool-ecpark-agent/src/branch/master/ecpark-agent-plugins/agent-plugin-spring/src/test/java/cn/ecpark/tool/agent/plugin/spring/CombineBenchmark.java )
...
####拦截Http请求-1
| [测试用例](http://git.ym/g-infrast/tool-ecpark-agent/src/branch/master/ecpark-agent-plugins/agent-plugin-httpclient/src/test/java/cn/ecpark/tool/agent/plugin/httpclient/HttpClientBenchmark.java )
...
#### 拦截Http请求-2
[测试用例](http://git.ym/g-infrast/tool-ecpark-agent/src/branch/master/ecpark-agent-plugins/agent-plugin-httpclient/src/test/java/cn/ecpark/tool/agent/plugin/httpclient/HttpClientBenchmark.java ) |  使用本地接口(该接口不做任何处理直接返回)
...
####拦截Jedis方法：[测试用例](http://git.ym/g-infrast/tool-ecpark-agent/src/branch/master/ecpark-agent-plugins/agent-plugin-jedis/src/test/java/cn/ecpark/tool/agent/plugin/jedis/RedisBenchmark.java )
...
####MongoDB：[测试用例](http://git.ym/g-infrast/tool-ecpark-agent/src/branch/master/ecpark-agent-plugins/agent-plugin-mongo/src/test/java/cn/ecpark/tool/agent/plugin/mongo/MongoBenchmark.java )
...
![directory-structure](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/directory-structure.png)
...
```sh
java -Dfile.encoding=utf-8 -Xms256m -Xmx512m -javaagent:/目录/ecpark-agent/lib/ecpark-agent.jar -DMonitorAgent.service.name=应用名称 -cp ../conf:../lib/* com.xxx.Application
```
...
```sh
java -Dfile.encoding=utf-8 -Xms256m -Xmx512m -javaagent:/目录/ecpark-agent/lib/ecpark-agent.jar -DMonitorAgent.service.name=应用名称 -jar yourApp.jar
```
...
```sh
CATALINA_OPTS="$CATALINA_OPTS -javaagent:/目录/ecpark-agent/lib/ecpark-agent.jar -DMonitorAgent.service.name=应用名称";
...
```sh
set "CATALINA_OPTS=-javaagent:/目录/ecpark-agent/lib/ecpark-agent.jar -DMonitorAgent.service.name=应用名称"
```
...
2020-02-11 14:34:23.869[INFO]-[schedule-4]-[c.e.t.a.c.u.LogUtil.println(71)]: ecpark-monitor/1581402862/statistic/method/RT?sign=cn.ecpark.tool.javaagent.TestService.add%28int%2Cint%29&rt_max=0&rt_min=0&num=10&rt_total=0
```
...
![ui-1](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/ui-1.png)

![ui-2](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/ui-2.png)

![ui-3](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/ui-3.png)

![ui-4](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/ui-4.png)

![ui-5](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/ui-5.png)

## 扩展（接口）

通过创建项目并引入api包（ecpark-agent-api，该包无其他依赖），可支持以下插件自定义扩展（参考现有插件的实现方式）：

![yangjian-agent](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/yangjian-agent.png)

### 快速扩展示例

场景：只监控TestService.execute(String cmd)的QPS/RT
...
public class TestMatcher implements IMetricMatcher {
	...
	public IConfigMatch match() {
		return new CombineAndMatch(Arrays.asList(
				new MethodRegexMatch(".*cn\\.xxx\\.plugin\\.test\\.TestService\\.execute\\(.*"),
	...
	public LoadClassKey loadClass(MethodType type) {
		return new LoadClassKey("cn.xxx.plugin.test.TestConvert");
	}
}
```
...
5、在项目目录/src/main/resources/META-INF/services下增加文件cn.ecpark.tool.agent.api.base.SPI，并添加以下内容
...
8、增加一个main方法测试拦截，并按照接入-> 启动脚本运行

> 如果在IDE下运行，需配置对应IDE的探针参数，eclipse可在Run Configurations ...找到对应的Java Application，在Arguments -> VM arguments下增加：`-javaagent:\探针包目录\ecpark-agent\lib\ecpark-agent.jar -DMonitorAgent.service.name=agent-main-test`
...
![IConfigMatch](http://git.ym/g-infrast/tool-ecpark-agent/raw/branch/master/docs/readme-files/IConfigMatch.png)
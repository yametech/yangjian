...
public class TraceLogReport implements IReport {
	private static ILogger log = LoggerFactory.getLogger(AppenderFactory.TRACE_APPENDER);
	...
	@Override
	public String type() {
		return Constants.ReportType.LOG_TRACE;
	}

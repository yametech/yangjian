...
public class TestMatcher implements IMatchPriority {

    @Override
    public IConfigMatch match() {
        return new CombineOrMatch(Arrays.asList(
                new CombineAndMatch(Arrays.asList(
                    new ClassMatch("zipkin2.Span"),
                    new MethodConstructorMatch()
                ))
//                new CombineAndMatch(Arrays.asList(
//                    new ClassMatch("java.util.concurrent.ScheduledThreadPoolExecutor"),
//                    new MethodConstructorMatch()
//                ))
        ));
    }
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.core.trace.TestInterceptor");
    }
}

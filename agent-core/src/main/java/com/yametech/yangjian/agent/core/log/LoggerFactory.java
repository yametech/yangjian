...
public class LoggerFactory implements ILoggerFactory {
     ...
     */
    static {
        String configPath = System.getProperty(LOG_CONFIG_PATH_KEY);
        if (StringUtil.isEmpty(configPath)) {
            configPath = AgentPath.getCompatiblePath().getPath() + File.separator + "config" + File.separator + LOG_CONFIG_NAME;
        }
        try {

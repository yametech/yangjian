 ...
 * @date 2020/6/14
 */
public class ChannelWriteTraceMatcher implements ITraceMatcher {
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.lettuce.trace.ChannelWriteSpanCreater");
    }

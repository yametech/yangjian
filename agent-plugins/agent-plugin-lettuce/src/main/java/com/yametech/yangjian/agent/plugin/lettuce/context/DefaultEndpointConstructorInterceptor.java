 ...
 * @date 2020/6/14
 */
public class DefaultEndpointConstructorInterceptor implements IConstructorListener {

    @Override
    public void constructor(Object thisObj, Object[] allArguments) throws Throwable {
        ((IContext) thisObj)._setAgentContext(REDIS_URL_CONTEXT_KEY, ((IContext) allArguments[0])._getAgentContext(REDIS_URL_CONTEXT_KEY));
    }

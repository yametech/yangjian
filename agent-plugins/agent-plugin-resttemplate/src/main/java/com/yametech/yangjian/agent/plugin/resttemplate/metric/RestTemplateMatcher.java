 ...
 * @date 2020/6/26
 */
public class RestTemplateMatcher implements IMetricMatcher {
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.resttemplate.metric.RestTemplateConvert");
    }
}

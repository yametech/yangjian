 ...
 * @date 2020/6/26
 */
public class CreateRequestMatcher implements ITraceMatcher {

    @Override
    public IConfigMatch match() {
        return new CombineAndMatch(Arrays.asList(
                new ClassMatch("org.springframework.http.client.support.HttpAccessor"),
                new MethodNameMatch("createRequest")
        ));
    }

    @Override
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.resttemplate.trace.CreateRequestInterceptor");
    }

 ...
 * @date 2020/4/27
 */
public class KafkaConsumerTraceMatcher implements ITraceMatcher {
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.kafka.trace.KafkaConsumerSpanCreater");
    }
}

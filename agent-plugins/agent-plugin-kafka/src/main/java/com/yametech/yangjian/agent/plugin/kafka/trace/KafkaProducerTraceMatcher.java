 ...
 * @date 2020/4/27
 */
public class KafkaProducerTraceMatcher implements ITraceMatcher {
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.kafka.trace.KafkaProducerSpanCreater");
    }
}

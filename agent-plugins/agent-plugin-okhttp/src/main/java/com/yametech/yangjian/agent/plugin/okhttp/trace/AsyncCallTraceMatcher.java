 ...
 * @date 2020/4/22
 */
public class AsyncCallTraceMatcher implements ITraceMatcher {
    ...
    public IConfigMatch match() {
        return new CombineAndMatch(Arrays.asList(
                new ClassMatch("okhttp3.RealCall$AsyncCall"),
                new MethodNameMatch("execute")));
    }

    @Override
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.okhttp.trace.AsyncCallSpanCreater");
    }
}

 ...
 * @date 2020/4/22
 */
public class EnqueueMatcher implements InterceptorMatcher {

    @Override
    public IConfigMatch match() {
        return new CombineAndMatch(Arrays.asList(
                new ClassMatch("okhttp3.RealCall"),
                new MethodNameMatch("enqueue"),
                new MethodArgumentIndexMatch(0, "okhttp3.Callback")));
    }

    @Override
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.okhttp.EnqueueInterceptor");
    }
}

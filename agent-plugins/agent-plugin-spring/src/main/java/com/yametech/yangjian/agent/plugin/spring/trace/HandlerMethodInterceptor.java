 ...
 * @date 2020/6/3
 */
public class HandlerMethodInterceptor implements IMethodAOP {

    /**
     * 主要兼容spring低版本用于传递response对象给当前线程上下文
     */
    public static ThreadLocal<Object> CONTEXT_LOCAL = new ThreadLocal<>();

    @Override
    public BeforeResult before(Object thisObj, Object[] allArguments, Method method) throws Throwable {
        CONTEXT_LOCAL.set(((NativeWebRequest) allArguments[2]).getNativeResponse());
        return null;
    }

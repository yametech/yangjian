 ...
 * @date 2020/5/2
 */
public class StatementImplSpanCreater extends AbstractStatementSpanCreater {
    private static final String SPAN_NAME_FORMAT = "Mysql/Statement/%s";
    ...
    public BeforeResult<SpanInfo> before(Object thisObj, Object[] allArguments, Method method) throws Throwable {
        ...
        if (StringUtil.isEmpty(sql) && allArguments.length > 0) {

 ...
 * @date 2020/5/4
 */
public class CreatePreparedStatementMatcher implements InterceptorMatcher {
    ...
    public IConfigMatch match() {
        return new CombineOrMatch(Arrays.asList(
                ...
                new CombineAndMatch(Arrays.asList(
                        ...
                        new MethodNameMatch("prepareStatement"),
    ...
    public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
        return new LoadClassKey("com.yametech.yangjian.agent.plugin.mysql.CreatePreparedStatementInterceptor");
    }
}

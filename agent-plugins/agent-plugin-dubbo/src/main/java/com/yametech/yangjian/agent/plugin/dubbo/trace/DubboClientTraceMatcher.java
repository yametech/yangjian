...
public abstract class DubboClientTraceMatcher implements ITraceMatcher {
	...
	public static class ApacheDubboClientTraceMatcher extends DubboClientTraceMatcher {
		@Override
		...
		public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
			return new LoadClassKey("com.yametech.yangjian.agent.plugin.dubbo.trace.ApacheDubboClientSpanCreater");
		}
	}

	public static class AlibabaDubboClientTraceMatcher extends DubboClientTraceMatcher {
		@Override
		public IConfigMatch match() {
			return new CombineAndMatch(Arrays.asList(
		...
		@Override
		public LoadClassKey loadClass(MethodType type, MethodDefined methodDefined) {
			return new LoadClassKey("com.yametech.yangjian.agent.plugin.dubbo.trace.AlibabaDubboClientSpanCreater");
		}
	}
}

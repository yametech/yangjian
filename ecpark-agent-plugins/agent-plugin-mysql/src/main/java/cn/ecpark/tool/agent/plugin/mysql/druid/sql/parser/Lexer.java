 ...
 */
package cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser;

import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.CharTypes.isFirstIdentifierChar;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.CharTypes.isIdentifierChar;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.CharTypes.isWhitespace;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.LayoutCharacters.EOI;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.SQLParserFeature.KeepComments;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.SQLParserFeature.OptimizedForParameterized;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.SQLParserFeature.SkipComments;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.COLONCOLON;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.COLONEQ;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.COMMA;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.DOT;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.EOF;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.EQ;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.ERROR;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.LBRACE;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.LBRACKET;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.LITERAL_ALIAS;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.LITERAL_CHARS;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.LPAREN;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.RBRACE;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.RBRACKET;
import static cn.ecpark.tool.agent.plugin.mysql.druid.sql.parser.Token.RPAREN;
...
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.dialect.mysql.parser.MySqlLexer;
...
import cn.ecpark.tool.agent.plugin.mysql.druid.util.StringUtils;

 ...
 */
package cn.ecpark.tool.agent.plugin.mysql.druid.sql.visitor;

import java.util.ArrayList;
import java.util.List;

import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLAdhocTableSource;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLArgument;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLArrayDataType;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLCommentHint;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLCurrentTimeExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLCurrentUserExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLDataType;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLDataTypeRefExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLDeclareItem;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLKeep;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLLimit;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLMapDataType;
...
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLOver;
...
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLPartitionByHash;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLPartitionByList;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLPartitionByRange;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLPartitionValue;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLRecordDataType;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLStructDataType;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLSubPartition;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLSubPartitionByHash;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLSubPartitionByList;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.SQLWindow;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLAggregateExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLAllColumnExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLAllExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLAnyExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLArrayExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLBetweenExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLBinaryExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLBinaryOpExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLBinaryOpExprGroup;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLBooleanExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLCaseExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLCaseStatement;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLCastExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLCharExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLContainsExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLCurrentOfCursorExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLDateExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLDecimalExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLDefaultExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLExistsExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLFlashbackExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLGroupingSetExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLHexExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLIdentifierExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLInListExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLInSubQueryExpr;
...
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLListExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLMethodInvokeExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLNCharExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLNotExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLNullExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLNumberExpr;
...
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLRealExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLSequenceExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLSizeExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLSomeExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLTimestampExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLUnaryExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLValuesExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.expr.SQLVariantRefExpr;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.statement.*;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.statement.SQLInsertStatement.ValuesClause;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.statement.SQLMergeStatement.MergeInsertClause;
import cn.ecpark.tool.agent.plugin.mysql.druid.sql.ast.statement.SQLMergeStatement.MergeUpdateClause;

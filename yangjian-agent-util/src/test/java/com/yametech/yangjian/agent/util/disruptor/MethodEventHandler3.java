...
public class MethodEventHandler3 implements EventHandler<MethodEvent>, WorkHandler<MethodEvent> {
	private static final Logger log = LoggerFactory.getLogger(MethodEventHandler3.class);
